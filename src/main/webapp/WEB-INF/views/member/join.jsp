...
<div class="container ">
  <div class="mb-3 px-3 py-3 pt-md-5 pb-md-4 mx-auto" align="center">
	<br><h2 style="font-weight: bold; color: #2C4B7B;">회원가입</h2><br>
	<form id="joinForm" action="join_ok" method="post">
	  <div class="w-50 text-left">
	    <label for="mem_id">아이디</label>
	    <div class="form-group row">
	       <div class="col-md-8">
		     <input type="text" class="form-control" id="mem_id" name="mem_id" placeholder="아이디를  8~15자 이내로 입력하세요.">
		   </div>
	       <div class="col-md-4">
	  ...
	  <div class="form-group w-50 text-left">
	    ...
	    <input type="password" class="form-control" id="mem_pw_check">
	  </div>
	  <div class="form-group w-50 text-left">
	  ...
	  <div class="form-group w-50 text-left">
	   ...
	   <div class="w-50 text-left">
	     ...
	     <div class="form-group row">
	       <div class="col-md-8">
	        <input type="email" class="form-control" id="mem_email" name="mem_email" placeholder="email@example.com">
	       </div>
	       <div class="col-md-4">	
	  ...
	  <div class="w-50 text-left">
	    ...
	    <div class="form-group row">
	      <div  class="col-md-8">
	        <input type="text" class="form-control" id="sample2_postcode" name="mem_postcode">
	      </div>
	      <div class="col-md-4">
	  ...
	  <div class="form-group mb-3">
  	    <button type="button" class="btn btn-secondary btn-lg col-md-6 disabled" id="btnJoin">회원가입</button>	
  	  </div>
		...
		$("#btnIdCheck").on("click", function(){
			...
			$.ajax({
				...
				success: function(result) {
					...
					$("#idCheckStatus").css({'display':'block', 'color':'red'});
					
					if(result == "yes") {
						$("#idCheckStatus").html("사용 가능");
						isIdCheck = true;
					}else{
						$("#idCheckStatus").html("사용 불가능");
						isIdCheck = false;
					}
				}
			});
			...
			$.ajax({
				...
				success: function(result) {
					if(result == "success") {
						...
						alert("메일 발송이 실패되었습니다. 메일 주소를 확인하세요.")
					}
				}
			});
		});
