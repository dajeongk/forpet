  ...
  <form id="findPWForm" action="findPW" method="post">
	...
	<div class="form-check form-check-inline">
  	...
  	<div class="form-group">
  	  <div class="col-sm-6">
  	    <input type="text" class="form-control" id="mem_id" name="mem_id" value="아이디"> 
  	  </div>
  	</div>
  	<div class="form-group">
  	  <div class="col-sm-6">
  	...
  	<div class="form-group">
  	  <div class="col-sm-6">
  	    <button type="submit" class="btn btn-secondary btn-lg btn-block disabled" id="btnfindPW">임시비밀번호 발급</button>	
  	  </div>
  	</div>
  </form>
