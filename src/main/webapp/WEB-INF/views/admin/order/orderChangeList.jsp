  ...
  <div class="row"> 
    <div class="col-md-12">
  	  <div class="box box-primary">
  		...
  		<div class="box-body">
  		  <form id="searchForm" action="/admin/order/orderChangeList" method="get">
          ...
          <tbody>
            <c:forEach items="${orderChangeList }" var="orderVO">
            ...
            <tr>
              ...
              <td><c:out value="${orderVO.odr_status }" /></td>
              <td><fmt:formatDate value="${orderVO.odr_event_date }" pattern="yyyy-MM-dd hh:mm" /></td>
              <td><c:out value="${orderVO.event_name }" /></td>
            </tr>
            </c:forEach>
          </tbody>
        </table>
        ...
        <nav aria-label="...">
          ...
          <!-- 페이지 번호 클릭시 orderChangeList주소로 보낼 파라미터 작업 -->
          <form id="actionForm" action="/admin/order/orderChangeList" method="get">
...
<script>
  ...
  $(document).ready(function(){
    ...
    $("ul.pagination li a.page-link").on("click", function(e){
      ...
      actionForm.attr("action", "/admin/order/orderChangeList");
