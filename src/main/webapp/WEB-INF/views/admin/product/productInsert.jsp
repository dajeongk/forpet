    ...
    <section class="content container-fluid">
      <div class="row">
      	<div class="col-md-12">
                ...
                <div class="col-sm-2">
                  <select id="firstCategory" name="ctg_code_prt" class="form-control">
                    ...
                    <c:forEach items="${cateList }" var="categoryVO">
                      <option value="${categoryVO.ctg_code }">${categoryVO.ctg_name }</option>
                    </c:forEach>
                  </select>
                </div>
                  <div class="col-sm-2">
              ...
              <div class="form-group row">
                <label for="pdt_sell_amount" class="col-sm-2 col-form-label">판매수량</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="pdt_sell_amount" name="pdt_sell_amount">
                </div>
